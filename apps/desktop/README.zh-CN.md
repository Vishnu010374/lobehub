...
Student-AI Desktop 是 [Student-AI](https://github.com/lobehub/lobehub) 的跨平台桌面应用程序，使用 Electron 构建，提供了更加原生的桌面体验和功能。
...
- **⚡ 高级窗口管理**：多窗口架构，支持主题同步
- **🔗 远程服务器同步**：与远程 Student-AI 实例的安全数据同步
...
1. Fork [Student-AI 仓库](https://github.com/lobehub/lobehub)
2. 按照我们的设置指南建立桌面开发环境
3. 对桌面应用程序进行修改
