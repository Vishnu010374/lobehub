...
This guide covers the standard patterns for implementing Upstash Workflow + QStash async workflows in the Student-AI codebase.

## 🎯 The Three Core Patterns

All workflows in Student-AI follow the same 3-layer architecture with three essential patterns:
