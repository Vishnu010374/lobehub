---
name: cli
description: Student-AI CLI (@lobehub/cli) development guide. Use when working on CLI commands, adding new subcommands, fixing CLI bugs, or understanding CLI architecture. Triggers on CLI development, command implementation, or `lh` command questions.
disable-model-invocation: true
---

# Student-AI CLI Development Guide

## Overview

Student-AI CLI (`@lobehub/cli`) is a command-line tool for managing and interacting with Student-AI services. Built with Commander.js + TypeScript.
