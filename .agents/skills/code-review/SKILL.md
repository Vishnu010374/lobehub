---
name: code-review
description: 'Code review checklist for Student-AI. Use when reviewing PRs, diffs, or code changes. Covers correctness, security, quality, and project-specific patterns.'
---
