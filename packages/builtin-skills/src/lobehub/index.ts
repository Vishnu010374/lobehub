...
export const Student-AIIdentifier = 'lobehub';
...
export const Student-AISkill: BuiltinSkill = {
  avatar: LOBEHUB_AVATAR,
  content: systemPrompt,
  description:
    'Manage the Student-AI platform via CLI — knowledge bases, memory, agents, files, search, generation, and more.',
  identifier: Student-AIIdentifier,
  name: 'Student-AI',
