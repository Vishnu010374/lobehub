...
export const SkillStoreManifest: BuiltinToolManifest = {
  api: [
    {
      description:
        "Search for skills in the Student-AI Market. Use this to discover available skills that can extend Claude's capabilities. Search across skill names, descriptions, and summaries. Results can be filtered and sorted by various criteria (stars, downloads, etc).",
    ...
    {
      description:
        'Import/install a skill directly from the Student-AI Market using its identifier. This is the recommended way to install skills from the market after searching with searchSkill. The skill will be downloaded and installed automatically. Requires user confirmation before installation.',
  ...
  meta: {
    avatar: '🏪',
    description: 'Browse and install agent skills from the Student-AI marketplace',
    title: 'Skill Store',
  },
