...
export const useControls = ({ setUpdating }: { setUpdating: (updating: boolean) => void }) => {
  ...
  // Student-AI Skill related state
  ...
  // Load user's Student-AI Skill connections via SWR
  ...
  // Student-AI Skill Provider list items - only show installed or recommended
  ...
  // Builtin tool list items (excluding Klavis and Student-AI Skill)
  ...
  // Builtin Agent Skills list items (grouped under Student-AI)
  ...
  // Skills list items (including Student-AI Skill and Klavis)
  ...
  // Build Student-AI group children (including Builtin Agent Skills, builtin tools, and Student-AI Skill/Klavis)
  const lobehubGroupChildren: ItemType[] = [
    // 1. Builtin Agent Skills
    ...builtinAgentSkillItems,
    // 2. Builtin tools
    ...builtinItems,
    // 3. Student-AI Skill and Klavis (as builtin skills)
    ...skillItems,
  ];
  ...
  const installedPluginItems: ItemType[] = useMemo(() => {
    ...
    // Connected Student-AI Skill Providers
    const connectedLobehubSkillItems = lobehubSkillItems.filter((item) =>
      checked.includes(item.key as string),
    );

    // Merge enabled Student-AI Skill and Klavis (as builtin skills)
    ...
    // Build builtin tools group children (including Builtin Agent Skills, builtin tools, and Student-AI Skill/Klavis)
