...
const AgentTool = memo<AgentToolProps>(
  ({ agentId, showWebBrowsing = false, filterAvailableInWeb = false, useAllMetaList = false }) => {
    ...
    // Student-AI Skill Provider list items
    ...
    // Merge Builtin Agent Skills, builtin tools, Student-AI Skill Providers, and Klavis servers
    ...
    const installedTabItems: ItemType[] = useMemo(() => {
      ...
      // Student-AI group (Builtin Agent Skills + builtin + Student-AI Skill + Klavis)
