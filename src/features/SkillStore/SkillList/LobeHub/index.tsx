...
export const Student-AIList = memo<Student-AIListProps>(({ keywords }) => {
...
Student-AIList.displayName = 'Student-AIList';

export default Student-AIList;
