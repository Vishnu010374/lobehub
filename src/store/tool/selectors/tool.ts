 ...
 * 2. User-installed plugins (from s.installedPlugins) — exclude Klavis/Student-AI Skill/agent skill overlap
 * 3. Klavis MCP servers (connected) — description from KLAVIS_SERVER_TYPES
 * 4. Student-AI Skill servers (connected) — description from LOBEHUB_SKILL_PROVIDERS
 */
const availableToolsForDiscovery = (s: ToolStoreState): AvailableToolForDiscovery[] => {
  ...
  //    Exclude Klavis, Student-AI Skill, and agent skill entries (they are handled in dedicated sources)
  ...
  // 4. Student-AI Skill servers (connected only)
