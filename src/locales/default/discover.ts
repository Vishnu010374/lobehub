export default {
  ...
  'createGuide.func1.title': 'Submit in Student-AI',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Student-AI Community.',
  'footer.title': 'Share your creation on Student-AI Community today',
  ...
  'models.providerInfo.apiTooltip': 'Student-AI supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Student-AI Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Student-AI automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Student-AI marketplace with one click.',
