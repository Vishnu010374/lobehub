export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Student-AI server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Student-AI Cloud',
