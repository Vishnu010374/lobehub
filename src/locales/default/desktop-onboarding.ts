export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using Student-AI Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Student-AI. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Student-AI',
  ...
  'screen5.actions.signInCloud': 'Sign in to Student-AI Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Student-AI Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Student-AI Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Student-AI server instance',
