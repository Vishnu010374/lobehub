export default {
  ...
  'protocolInstall.official.badge': 'Student-AI Official Skill',
  'protocolInstall.official.description': 'Official Student-AI Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Student-AI does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'Student-AI Skills',
