export default {
  ...
  'memory.enabled.desc':
    'Allow Student-AI to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'skillStore.tabs.lobehub': 'Student-AI',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  // Student-AI Skill Providers i18n
