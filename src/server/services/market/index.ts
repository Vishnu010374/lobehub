...
export class MarketService {
  ...
  /**
   * Search for skills in the Student-AI Market
   */
  ...
  /**
   * Execute a Student-AI Skill tool
  ...
  /**
   * Fetch Student-AI Skills manifests from Market API
      ...
      for (const connection of connections) {
        try {
          ...
          const manifest: LobeToolManifest = {
            ...
            meta: {
              avatar: icon || '🔗',
              description: `Student-AI Skill: ${providerName}`,
