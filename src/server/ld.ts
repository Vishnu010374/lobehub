  ...
  genOrganization() {
    return {
      ...
      'description':
        ...
        'Student-AI is a work-and-lifestyle space to find, build, and collaborate with agent teams that grow with you.',
