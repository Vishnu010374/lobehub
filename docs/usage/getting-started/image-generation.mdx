...
Describe what you want — Student-AI turns text into images. Product prototypes, design inspiration, illustrations, or creative exploration: choose a model, set your parameters, and get high-quality images in seconds. All generated images are automatically saved to your Resource Library.

## Get Started

Click **Drawing** on the Student-AI main interface to open the image generation page.
...
Student-AI offers multiple AI image generation models. Different models have different strengths:
