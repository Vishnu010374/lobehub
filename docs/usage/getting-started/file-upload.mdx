...
Student-AI provides comprehensive file upload capabilities, enabling AI agents to access, analyze, and reference documents, images, code, and other files during conversations.
...
Student-AI includes an integrated file viewer:
...
- Files are stored in your Student-AI instance
