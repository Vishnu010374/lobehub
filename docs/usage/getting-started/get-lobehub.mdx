---
title: Getting Student-AI
description: >-
  Access Student-AI on any device — browser, desktop (macOS/Windows), or mobile
...
Student-AI runs wherever you work — browser, desktop, or phone. Sign in once and your Agents, Pages, and Memory stay in sync across every device.
...
**Best for:** Quick access, trying Student-AI before installing, or using it on shared / restricted machines.
...
Sign in with your Student-AI account to access Agents and conversations on the go.
