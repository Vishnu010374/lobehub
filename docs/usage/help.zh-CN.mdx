---
title: 帮助与支持
description: 获取 Student-AI 帮助——常用指南、社区支持、问题反馈及联系方式。
tags:
  - Student-AI
  - 帮助
  - 支持
...
- [获取 Student-AI](/zh/docs/usage/getting-started/get-lobehub) — 浏览器、桌面端或移动端
...
| **Reddit**        | 讨论与社区动态      | [r/Student-AI](https://www.reddit.com/r/Student-AI/)                   |
