...
Click the **Share** button in the top-right corner of the chat window to export and share your current conversation. Student-AI supports multiple formats — choose the one that fits how you want to use it.
...
- **Default** — Student-AI's standard JSON format
