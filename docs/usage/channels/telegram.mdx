---
title: Connect Student-AI to Telegram
description: >-
  Learn how to create a Telegram bot and connect it to your Student-AI agent as a
...
# Connect Student-AI to Telegram
...
By connecting a Telegram channel to your Student-AI agent, users can interact with the AI assistant through Telegram private chats and group conversations.
...
<Steps>
  ...
  1. Choose a **display name** for your bot (e.g., "Student-AI Assistant")
...
## Step 2: Configure Telegram in Student-AI

<Steps>
  ### Open Channel Settings

  In Student-AI, navigate to your agent's settings, then select the **Channels** tab. Click **Telegram** from the platform list.
  ...
  Click **Save Configuration**. Student-AI will automatically register the webhook URL with Telegram — no manual URL copying is required.
...
Click **Test Connection** in Student-AI's channel settings to verify the integration. Then open Telegram, find your bot by searching its username, and send a message. The bot should respond through your Student-AI agent.
...
- **Webhook registration failed:** Ensure your Student-AI subscription is active. Telegram requires HTTPS endpoints for webhooks, which Student-AI provides automatically.
