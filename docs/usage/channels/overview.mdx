...
description: >-
  Connect your Student-AI agents to external messaging platforms like Discord,
...
Channels allow you to connect your Student-AI agents to external messaging platforms. Once connected, users can interact with your AI assistant directly in the chat apps they already use — no need to visit Student-AI.
...
Each channel integration works by linking a bot account on the target platform to a Student-AI agent. When a user sends a message to the bot, Student-AI processes it through the agent and sends the response back to the same conversation.
...
- **Multiple channels simultaneously** — A single agent can be connected to Discord, Slack, Telegram, QQ, Feishu, and Lark at the same time. Student-AI routes messages to the correct agent automatically.
- **Secure credential storage** — All bot tokens and app secrets are encrypted before being stored.

## Getting Started

1. Enable **Developer Mode** in Student-AI: **Settings** → **Advanced Settings** → **Developer Mode**
