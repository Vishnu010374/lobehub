---
title: Connect Student-AI to QQ
description: >-
  Learn how to create a QQ bot and connect it to your Student-AI agent as a
...
By connecting a QQ channel to your Student-AI agent, users can interact with the AI assistant through QQ group chats, guild channels, and direct messages.

## Prerequisites

- A Student-AI account with an active subscription
- A QQ account
...
<Steps>
  ...
  In the QQ Open Platform, navigate to **Development Settings** → **Callback Configuration**. You will need to paste the Student-AI Callback URL here after completing Step 2.
</Steps>

## Step 2: Configure QQ in Student-AI

<Steps>
  ### Open Channel Settings

  In Student-AI, navigate to your agent's settings, then select the **Channels** tab. Click **QQ** from the platform list.
...
<Steps>
  ...
  Go back to the QQ Open Platform, navigate to **Development Settings** → **Callback Configuration**. Paste the **Callback URL** you copied from Student-AI.
  ...
  The QQ Open Platform will send a verification request to your Callback URL. Student-AI handles this automatically using Ed25519 signature verification.
</Steps>
...
Click **Test Connection** in Student-AI's channel settings to verify the integration. Then open QQ, find your bot, and send a message. The bot should respond through your Student-AI agent.
...
- **Callback URL verification failed:** Ensure you saved the configuration in Student-AI first and the URL was copied correctly. Student-AI handles Ed25519 verification automatically.
...
- **Test Connection failed:** Double-check the App ID and App Secret in Student-AI's channel settings.
