---
title: Connect Student-AI to Lark
description: >-
  Learn how to create a Lark custom app and connect it to your Student-AI
...
By connecting a Lark channel to your Student-AI agent, team members can interact with the AI assistant directly in Lark private chats and group conversations.
...
<Steps>
  ...
  Click **Create Enterprise App**. Fill in the app name (e.g., "Student-AI Assistant"), description, and icon, then submit the form.
...
## Step 3: Configure Lark in Student-AI

<Steps>
  ### Open Channel Settings

  In Student-AI, navigate to your agent's settings, then select the **Channels** tab. Click **Lark** from the platform list.
...
<Steps>
  ...
  Paste the **Event Subscription URL** you copied from Student-AI into the **Request URL** field. The platform will verify the endpoint automatically.
  ...
  This allows your app to receive messages and forward them to Student-AI.
  ...
  Go back to Student-AI's channel settings and fill in:
...
Back in Student-AI's channel settings, click **Test Connection** to verify the credentials. Then find your bot in Lark by searching its name and send it a message to confirm it responds.
...
- **Event Subscription URL verification failed:** Ensure you saved the configuration in Student-AI first, and the URL was copied correctly.
...
- **Test Connection failed:** Double-check the App ID and App Secret. Make sure you selected "Lark" (not "飞书") in Student-AI's channel settings.
