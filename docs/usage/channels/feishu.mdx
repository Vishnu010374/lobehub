---
title: Connect Student-AI to Feishu (飞书)
description: >-
  Learn how to create a Feishu custom app and connect it to your Student-AI
...
# Connect Student-AI to Feishu (飞书)
...
By connecting a Feishu channel to your Student-AI agent, team members can interact with the AI assistant directly in Feishu private chats and group conversations.
...
<Steps>
  ...
  Click **Create Enterprise App**. Fill in the app name (e.g., "Student-AI 助手"), description, and icon, then submit the form.
...
## Step 3: Configure Feishu in Student-AI

<Steps>
  ### Open Channel Settings

  In Student-AI, navigate to your agent's settings, then select the **Channels** tab. Click **飞书** (Feishu) from the platform list.
...
Back in Student-AI's channel settings, click **Test Connection** to verify the credentials. Then find your bot in Feishu by searching its name and send it a message to confirm it responds.
