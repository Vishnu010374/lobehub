---
title: Connect Student-AI to Slack
description: >-
  Learn how to create a Slack app and connect it to your Student-AI agent as a
...
By connecting a Slack channel to your Student-AI agent, users can interact with the AI assistant directly through Slack channels and direct messages.
...
<Steps>
  ...
  Visit [Slack API Apps](https://api.slack.com/apps) and click **Create New App**. Choose **From scratch**, give your app a name (e.g., "Student-AI Assistant"), select the workspace to install it in, and click **Create App**.
...
## Step 2: Configure Slack in Student-AI

<Steps>
  ### Open Channel Settings

  In Student-AI, navigate to your agent's settings, then select the **Channels** tab. Click **Slack** from the platform list.
  ...
  Click **Save Configuration**. Student-AI will save your credentials and display a **Webhook URL**.
...
<Steps>
  ...
  Paste the **Webhook URL** you copied from Student-AI into the **Request URL** field. Slack will send a verification challenge — Student-AI will respond automatically.
...
Back in Student-AI's channel settings for Slack, click **Test Connection** to verify the integration. Then go to your Slack workspace, invite the bot to a channel, and mention it with `@YourBotName` to confirm it responds.
