...
description: >-
  Master Student-AI with keyboard shortcuts — command palette, Agent switching,
...
Student-AI provides a comprehensive set of keyboard shortcuts so you can work without constantly reaching for the mouse. Master a few key ones and your workflow noticeably speeds up — especially when switching Agents, managing conversations, or navigating the interface.
