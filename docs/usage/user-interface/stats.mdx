...
description: >-
  Track your Student-AI usage — days active, Agents, conversations, model usage.
...
Data Analytics gives you a clear picture of how you use Student-AI. View usage days, Agent count, conversation volume, and model distribution — plus an activity heatmap for the past year. Understand your patterns, spot trends, and optionally share your stats with others.
...
| Metric                 | Description                                      |
| ---------------------- | ------------------------------------------------ |
| **Days of Use**        | Total days since you first started using Student-AI |
...
- **Use the heatmap for reflection** — If you want to use Student-AI more consistently, the heatmap can help you set and track habits.
