---
title: 在 Student-AI 中使用讯飞星火
description: 学习如何在 Student-AI 中配置和使用讯飞星火的API Key，以便开始对话和交互。
tags:
  - Student-AI
  - 讯飞星火
  - API密钥
...
至此你已经可以在 Student-AI 中使用讯飞星火提供的模型进行对话了。
