---
title: 在 Student-AI 中使用书生浦语
description: 学习如何在 Student-AI 中配置和使用书生浦语的 API Key，以便开始对话和交互。
tags:
  - Student-AI
  - 书生浦语
  - API密钥
...
至此你已经可以在 Student-AI 中使用书生浦语提供的模型进行对话了。
