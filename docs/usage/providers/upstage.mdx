---
title: Using Upstage in Student-AI
description: >-
  Learn how to configure and use Upstage's API Key in Student-AI to start
...
This guide will walk you through how to use Upstage within Student-AI.
...
<Steps>
  ...
  ### Step 2: Configure Upstage in Student-AI
...
And that’s it! You’re now ready to use Upstage’s models for conversations in Student-AI.
