---
title: Using Vercel AI Gateway in Student-AI
description: Learn how to integrate and use the unified API of Vercel AI Gateway in Student-AI
tags:
  - Student-AI
  - Vercel AI Gateway
  - API Key
...
# Using Vercel AI Gateway in Student-AI
...
This guide will walk you through how to use Vercel AI Gateway within Student-AI.
...
<Steps>
  ...
  ### Step 2: Configure Vercel AI Gateway in Student-AI
...
That's it! You can now start chatting in Student-AI using models provided by Vercel AI Gateway.
