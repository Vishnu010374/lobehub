---
title: Using Vertex AI API Key in Student-AI
description: >-
  Learn how to configure and use Vertex AI models in Student-AI, obtain your API
...
# Using Vertex AI in Student-AI

<Image alt={'Using Vertex AI in Student-AI'} cover src={'/blog/assets95e6fe7c19ebfb9ead1c5a267aaf2a4e.webp'} />
...
This guide will walk you through how to integrate Vertex AI models into Student-AI:
...
<Steps>
  ...
  ### Step 3: Configure Vertex AI in Student-AI

  - Open Student-AI and go to the App Settings > AI Service Providers section.
...
You're all set! You can now start using Vertex AI models in Student-AI for your conversations.
