...
description: Learn how to configure and use the ModelScope provider in Student-AI
tags:
  - ModelScope
---
...
ModelScope is an open-source AI model community by Alibaba, offering access to a wide range of AI models. This guide will walk you through setting up the ModelScope provider in Student-AI.
...
3. **Obtain an API Token**
   ...
   - Copy the token for use in Student-AI
...
For Student-AI integration issues:
