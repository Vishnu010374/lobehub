---
title: Using Cloudflare Workers AI in Student-AI
description: >-
  Learn how to configure and use the Cloudflare Workers AI API Key in Student-AI to
...
# Using Cloudflare Workers AI in Student-AI
...
This guide will walk you through how to use Cloudflare Workers AI in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Cloudflare Workers AI in Student-AI
...
You’re all set! You can now start using Cloudflare Workers AI models for conversations in Student-AI.
