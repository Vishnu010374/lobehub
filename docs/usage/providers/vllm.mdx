---
title: Using vLLM API Key in Student-AI
description: >-
  Learn how to configure and use vLLM language models in Student-AI, obtain an API
...
# Using vLLM in Student-AI

<Image alt={'Using vLLM in Student-AI'} cover src={'/blog/assets1049abec5850cebf8ce12cd50199b9c5.webp'} />
...
This guide will walk you through how to use vLLM in Student-AI:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in Student-AI

  - Open the `App Settings` panel in Student-AI
...
You're now ready to use vLLM-powered models in Student-AI for conversations.
