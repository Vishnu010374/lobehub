---
title: Using Azure OpenAI API Key in Student-AI
description: >-
  Learn how to configure and use Azure OpenAI models in Student-AI, including how
...
# Using Azure OpenAI in Student-AI

<Image alt={'Using Azure OpenAI in Student-AI'} cover src={'/blog/assets17870709/5efa34c2-6523-43e6-9ade-70ab5d802e13.webp'} />

This guide will walk you through how to use [Azure OpenAI](https://oai.azure.com/) in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Azure OpenAI in Student-AI
...
And that’s it! You’re now ready to start chatting with models powered by Azure OpenAI in Student-AI.
