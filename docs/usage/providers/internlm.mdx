---
title: Using InternLM in Student-AI
description: >-
  Learn how to configure and use your InternLM API Key in Student-AI to start
...
This guide will walk you through how to use InternLM within Student-AI.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in Student-AI
...
You’re all set! You can now start using InternLM-powered models in Student-AI for conversations and interactions.
