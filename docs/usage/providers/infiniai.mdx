---
title: Using Infini-AI in Student-AI
description: >-
  Learn how to configure and use Infini-AI's API Key in Student-AI to enable
...
This guide will walk you through the steps to quickly integrate Infini-AI's capabilities into Student-AI.
...
<Steps>
  ...
  ### Step 2: Configure the Model Service in Student-AI

  - Open Student-AI and go to the "Settings" page
