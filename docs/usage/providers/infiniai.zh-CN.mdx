---
title: 在 Student-AI 中使用无问芯穹
description: 学习如何在 Student-AI 中配置和使用无问芯穹的 API Key，实现 AI 对话交互。
tags:
  - Student-AI
  - 无问芯穹
  - API密钥
...
<Steps>
  ...
  ### 步骤二：配置 Student-AI 模型服务

  - 打开 Student-AI 进入「设置」界面
