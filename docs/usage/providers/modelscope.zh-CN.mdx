...
description: 学习如何在 Student-AI 中配置和使用 ModelScope 提供商
tags:
  - ModelScope
---
...
ModelScope（魔塔社区）是阿里巴巴的开源模型社区，提供各种 AI 模型的访问服务。本指南将帮助您在 Student-AI 中设置 ModelScope 提供商。
