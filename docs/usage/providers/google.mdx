---
title: Using Google Gemini API Key in Student-AI
description: >-
  This guide will walk you through how to configure and use Google Gemini, a
  powerful language model developed by Google AI, within Student-AI.
tags:
  - Google Gemini
  - Google AI
  - API Key
...
# Using Google Gemini in Student-AI

<Image alt={'Using Google Gemini in Student-AI'} cover src={'/blog/assets34400653/9a8dc1d4-152b-415f-a7cd-8f0c8fbb9913.webp'} />
...
This guide will show you how to use Google Gemini in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Google Gemini in Student-AI

  - Go to the Settings page in Student-AI
  - Under "AI Providers", locate the "Google Gemini" section

  <Image alt={'Enter Google Gemini API Key in Student-AI'} inStep src={'/blog/assets34400653/11442ce4-a615-49c4-937a-ca2ae93dd27c.webp'} />
...
And that’s it — you’re now ready to use Google Gemini in Student-AI!
