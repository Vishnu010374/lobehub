---
title: Using the Anthropic Claude API Key in Student-AI
description: >-
  Learn how to configure and use the Anthropic Claude API in Student-AI, including
...
# Using Anthropic Claude in Student-AI

<Image alt={'Using Anthropic Claude in Student-AI'} cover src={'/blog/assets17870709/620b956b-dcb2-442a-8bb1-9aa22681dfa4.webp'} />

The Anthropic Claude API is now publicly available. This guide will walk you through how to use [Anthropic Claude](https://www.anthropic.com/api) in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Anthropic Claude in Student-AI
...
That's it! You’re now ready to use Anthropic Claude models in Student-AI for conversations.
