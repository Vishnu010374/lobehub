---
title: Using the Groq API Key in Student-AI
description: >-
  Learn how to obtain a GroqCloud API Key and configure Groq in Student-AI to
...
# Using Groq in Student-AI

<Image alt={'Using Groq in Student-AI'} cover src={'/blog/assets17870709/1d840e27-fa74-4e71-b777-330bf41d6dff.webp'} />

Groq’s [LPU Inference Engine](https://wow.groq.com/news_press/groq-lpu-inference-engine-leads-in-first-independent-llm-benchmark/) has demonstrated outstanding performance in the latest independent large language model (LLM) benchmarks, redefining the standards for AI solutions with its incredible speed and efficiency. With the integration of Groq Cloud into Student-AI, you can now easily harness Groq’s technology to accelerate LLM performance within Student-AI.
...
This guide will walk you through how to use Groq in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Groq in Student-AI

  Go to `Settings` -> `AI Providers` in Student-AI, and find the configuration section for Groq. Paste the API Key you just obtained.

  <Image alt={'Groq Provider Settings'} height={274} inStep src={'/blog/assets34400653/88948a3a-6681-4a8d-9734-a464e09e4957.webp'} />
</Steps>

Next, in the assistant’s model selection menu, choose a model supported by Groq to start experiencing Groq’s powerful performance in Student-AI.
