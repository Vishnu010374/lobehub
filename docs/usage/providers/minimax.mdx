---
title: Using the Minimax API Key in Student-AI
description: >-
  Learn how to configure and use the MiniMax AI model in Student-AI. This guide
...
# Using Minimax in Student-AI

<Image alt={'Using Minimax in Student-AI'} cover src={'/blog/assets34400653/703f170b-c03b-4c71-b57d-c2357596bdfb.webp'} />
...
This guide will walk you through how to use MiniMax in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure MiniMax in Student-AI
...
You're all set! You can now start chatting with models powered by MiniMax in Student-AI.
