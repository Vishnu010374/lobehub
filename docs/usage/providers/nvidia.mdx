---
title: Using Nvidia NIM API Key in Student-AI
description: >-
  Learn how to configure and use Nvidia NIM AI models in Student-AI, obtain your
...
# Using Nvidia NIM in Student-AI

<Image alt={'Using Nvidia NIM in Student-AI'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
This guide will walk you through how to integrate and use AI models provided by Nvidia NIM in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in Student-AI

  - Go to the `App Settings` section in Student-AI and navigate to `AI Service Providers`.
...
That’s it! You’re now ready to use Nvidia NIM-powered models in Student-AI for your conversations.
