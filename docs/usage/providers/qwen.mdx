---
title: Using Tongyi Qianwen API Key in Student-AI
description: >-
  Learn how to configure and use Alibaba Cloud's Tongyi Qianwen model in
  Student-AI, offering powerful natural language understanding and generation
  capabilities.
tags:
  - Student-AI
  - Tongyi Qianwen
...
# Using Tongyi Qianwen in Student-AI

<Image alt={'Using Tongyi Qianwen in Student-AI'} cover src={'/blog/assets34400653/4e057b43-1e3e-4e96-a948-7cdbff303dcb.webp'} />
...
This guide will walk you through how to use Tongyi Qianwen in Student-AI:
...
<Steps>
  ...
  ### Step 3: Configure Tongyi Qianwen in Student-AI
...
You’re all set! You can now start using Tongyi Qianwen’s models in Student-AI for intelligent conversations.
