---
title: 在 Student-AI 中使用 GitHub Models
description: 学习如何在 Student-AI 中配置和使用 GitHub 的 API Key，以便开始对话和交互。
tags:
  - Student-AI
  - GitHub
  - GitHub Models
...
# 在 Student-AI 中使用 GitHub Models
...
本文将指导你如何在 Student-AI 中使用 GitHub Models。
...
<Steps>
  ...
  ### 步骤二：在 Student-AI 中配置 GitHub Models
...
至此你已经可以在 Student-AI 中使用 GitHub 提供的模型进行对话了。
