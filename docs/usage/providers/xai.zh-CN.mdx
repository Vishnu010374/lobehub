---
title: 在 Student-AI 中使用 xAI
description: 学习如何在 Student-AI 中配置和使用 xAI 的 API Key，以便开始对话和交互。
tags:
  - Student-AI
  - xAI
  - API密钥
...
至此你已经可以在 Student-AI 中使用 xAI 提供的模型进行对话了。
