---
title: Using the Together AI API Key in Student-AI
description: >-
  Learn how to configure and use the Together AI API key in Student-AI to start
...
# Using Together AI in Student-AI

<Image alt={'Using Together AI in Student-AI'} cover src={'/blog/assets34400653/28e025dd-367b-4add-85b6-499f4aacda61.webp'} />
...
This guide will walk you through how to use Together AI in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Together AI in Student-AI

  - Go to the Settings page in Student-AI
  - Under the AI Providers section, find the settings for together.ai

  <Image alt={'Enter your Together AI API key in Student-AI'} inStep src={'/blog/assets34400653/0cc6c9b8-4688-472b-a80f-f84c5ebbc719.webp'} />
...
And that’s it! You’re now ready to use Together AI models for conversations in Student-AI.
