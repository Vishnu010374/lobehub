---
title: Using LM Studio in Student-AI
description: >-
...
# Using LM Studio in Student-AI

<Image alt={'Using LM Studio in Student-AI'} cover src={'/blog/assets28749075f0c4d62c1642694a4ed9ec08.webp'} />
...
This guide will walk you through how to use LM Studio within Student-AI:
...
<Steps>
  ...
  ### Step 5: Connect LM Studio to Student-AI

  - Go to the `App Settings` in Student-AI and open the `AI Service Providers` section
...
And that’s it! You’re now ready to use models running in LM Studio directly within Student-AI.
