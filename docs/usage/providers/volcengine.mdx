---
title: Using Volcengine API Key in Student-AI
description: >-
  Learn how to configure and use Volcengine AI models in Student-AI, obtain your
...
# Using Volcengine in Student-AI

<Image alt={'Using Volcengine in Student-AI'} cover src={'/blog/assets80a8b9627374fc345f4bf8e3adf11074.webp'} />
...
This guide will walk you through how to use Volcengine in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Volcengine in Student-AI

  - Open the `App Settings` in Student-AI and go to the `AI Service Providers` section
...
You're now ready to start chatting with models powered by Volcengine in Student-AI.
