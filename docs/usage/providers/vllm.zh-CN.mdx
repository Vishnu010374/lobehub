---
title: 在 Student-AI 中使用 vLLM API Key
description: 学习如何在 Student-AI 中配置和使用 vLLM 语言模型，获取 API 密钥并开始对话。
tags:
  - Student-AI
  - vLLM
  - API密钥
...
# 在 Student-AI 中使用 vLLM

<Image alt={'在 Student-AI 中使用 vLLM'} cover src={'/blog/assets1049abec5850cebf8ce12cd50199b9c5.webp'} />

[vLLM](https://github.com/vllm-project/vllm)是一个开源的本地大型语言模型（LLM）部署工具，允许用户在本地设备上高效运行 LLM 模型，并提供兼容 OpenAI API 的服务接口。

本文档将指导你如何在 Student-AI 中使用 vLLM:
...
至此你已经可以在 Student-AI 中使用 vLLM 提供的模型进行对话了。
