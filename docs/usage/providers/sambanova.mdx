---
title: Using the SambaNova API Key in Student-AI
description: >-
  Learn how to configure and use SambaNova models in Student-AI, obtain your API
...
# Using SambaNova in Student-AI

<Image alt={'Using SambaNova in Student-AI'} cover src={'/blog/assetsd9e6fe2197270f0f774accd6abcf4019.webp'} />
...
This guide will walk you through how to use SambaNova in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in Student-AI

  - Go to the `App Settings` section in Student-AI
...
You're now ready to start chatting with models powered by SambaNova in Student-AI.
