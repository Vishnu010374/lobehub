---
title: Using Jina AI API Key in Student-AI
description: >-
  Learn how to configure and use Jina AI models in Student-AI, obtain your API key,
  and start chatting.
tags:
  - Student-AI
  - Jina AI
...
# Using Jina AI in Student-AI

<Image alt={'Using Jina AI in Student-AI'} cover src={'/blog/assetsc6ff27b7134f280727e1fd7ff83ed2fa.webp'} />
...
This guide will walk you through how to use Jina AI in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Jina AI in Student-AI
...
And that’s it! You’re now ready to start chatting with models powered by Jina AI in Student-AI.
