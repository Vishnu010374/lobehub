...
title: ''
description: >-
  Learn to configure ComfyUI in Student-AI for high-quality image generation and
  editing.
tags:
  - ComfyUI
  - FLUX
...
````markdown
---
title: Using ComfyUI in Student-AI for Image Generation
description: Learn how to configure and use the ComfyUI service in Student-AI to support high-quality image generation and editing with the FLUX model series.
tags:
  - ComfyUI
  - FLUX
  - Text-to-Image
...
# Using ComfyUI in Student-AI

<Image alt={'Using ComfyUI in Student-AI'} cover src={'https://hub-apac-1.lobeobjects.space/docs/e9b811f248a1db2bd1be1af888cf9b9d.png'} />

This guide will walk you through how to use [ComfyUI](https://github.com/comfyanonymous/ComfyUI) in Student-AI for high-quality AI image generation and editing.

## Introduction to ComfyUI

ComfyUI is a powerful GUI for Stable Diffusion and Flow Diffusion, offering a node-based workflow interface. Student-AI integrates ComfyUI with full support for the FLUX model series, enabling both text-to-image generation and image editing.
...
### Step 1: Configure ComfyUI in Student-AI

#### 1. Open Settings

- Go to the `Settings` panel in Student-AI
