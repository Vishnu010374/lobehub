---
title: Using OpenRouter API Key in Student-AI
description: >-
  Learn how to register, create an API key, add credit, and configure OpenRouter
  in Student-AI to start using a variety of powerful large language model APIs.
tags:
  - OpenRouter
  - API Key
  - Web UI
...
# Using OpenRouter in Student-AI

<Image alt={'Using OpenRouter in Student-AI'} cover src={'/blog/assets34400653/40520a43-ac03-4954-8a4d-282fbb946066.webp'} />
...
This guide will walk you through how to use OpenRouter in Student-AI:
...
<Steps>
  ...
  - In the pop-up dialog, give your API key a name, such as "Student-AI Key".
  ...
  ### Step 4: Configure OpenRouter in Student-AI
  ...
  <Image alt={'Configure OpenRouter in Student-AI'} height={518} inStep src={'/blog/assets34400653/5c3898ab-23d7-44c2-bbd9-b255e25e400c.webp'} />
...
You’re now ready to start using OpenRouter’s models in Student-AI for conversations.
