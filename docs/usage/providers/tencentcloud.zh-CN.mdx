---
title: 在 Student-AI 中使用腾讯云 API Key
description: 学习如何在 Student-AI 中配置和使用腾讯云 AI 模型，获取 API 密钥并开始对话。
tags:
  - Student-AI
  - 腾讯云
  - API密钥
...
<Image alt={'在 Student-AI 中使用腾讯云'} cover src={'/blog/assetsf625540e8340bafe69ccbb89ad75707a.webp'} />

[腾讯云（Tencent Cloud）](https://cloud.tencent.com/)是腾讯公司旗下的云计算服务品牌，专门为企业和开发者提供云计算服务。腾讯云提供了一系列 AI 大模型解决方案，通过这些工具可以稳定高效接入 AI 模型。

本文档将指导你如何在 Student-AI 中接入腾讯云的 AI 模型:
...
至此你已经可以在 Student-AI 中使用腾讯云提供的模型进行对话了。
