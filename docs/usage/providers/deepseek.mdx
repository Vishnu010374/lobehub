---
title: Using DeepSeek API Key in Student-AI
description: >-
  Learn how to configure and use the DeepSeek language model in Student-AI, obtain
...
# Using DeepSeek in Student-AI

<Image alt={'Using DeepSeek in Student-AI'} cover src={'/blog/assets34400653/b4d12904-9d5d-46de-bd66-901eeb9c8e52.webp'} />
...
This guide will walk you through how to use DeepSeek in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure DeepSeek in Student-AI

  - Go to the `App Settings` page in Student-AI
  - Under `AI Providers`, find the `DeepSeek` configuration section

  <Image alt={'Enter DeepSeek API Key in Student-AI'} inStep src={'/blog/assets93da89c4892a80e2e5a6caa49d80af5f.webp'} />
...
And that’s it! You’re now ready to start chatting with DeepSeek-powered models in Student-AI.
