---
title: Using the Stepfun API Key in Student-AI
description: >-
  Learn how to configure and use Stepfun's AI models in Student-AI, including how
...
# Using Stepfun in Student-AI

<Image alt={'Using Stepfun in Student-AI'} cover src={'/blog/assets34400653/95717e2b-1a55-4fca-a96b-b1c186ed4563.webp'} />
...
This guide will walk you through how to use Stepfun in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Stepfun in Student-AI
...
And that’s it! You’re now ready to start chatting with AI models powered by Stepfun in Student-AI.
