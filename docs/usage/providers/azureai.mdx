---
title: Using Azure AI API Key in Student-AI
description: >-
  Learn how to configure and use Azure AI models in Student-AI, obtain your API
...
# Using Azure AI in Student-AI

<Image alt={'Using Azure AI in Student-AI'} cover src={'/blog/assets29de82efbe7657a8b9ba7daf0904585d.webp'} />
...
This guide will walk you through how to integrate Azure AI models into Student-AI:
...
<Steps>
  ...
  ### Step 3: Configure Azure AI in Student-AI
...
That's it! You're now ready to use Azure AI models for conversations in Student-AI.
