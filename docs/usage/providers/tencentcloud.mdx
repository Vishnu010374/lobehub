---
title: Using Tencent Cloud API Key in Student-AI
description: >-
  Learn how to configure and use Tencent Cloud AI models in Student-AI, obtain your
...
# Using Tencent Cloud in Student-AI

<Image alt={'Using Tencent Cloud in Student-AI'} cover src={'/blog/assetsf625540e8340bafe69ccbb89ad75707a.webp'} />
...
This guide will walk you through how to integrate Tencent Cloud's AI models into Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in Student-AI

  - Open Student-AI and go to App Settings > AI Service Providers.
...
That's it! You’re now ready to use Tencent Cloud’s AI models in Student-AI for conversations.
