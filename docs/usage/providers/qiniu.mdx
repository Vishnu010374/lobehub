---
title: Using Qiniu Cloud's Large Language Model API Key in Student-AI
description: >-
  Learn how to configure and use Qiniu Cloud's large language models in Student-AI
...
# Using Qiniu Cloud's Large Language Model in Student-AI

<Image alt={'Using Qiniu Cloud LLM in Student-AI'} cover src={'/blog/assets48b5c19e20fb870c7bdd34bd3aefbb21.webp'} />
...
This guide will walk you through how to use Qiniu Cloud's large language models in Student-AI:
...
<Steps>
  ...
  ### Step 2: Configure Qiniu Cloud LLM Service in Student-AI
...
That's it! You're now ready to use Qiniu Cloud's large language models in Student-AI for intelligent conversations.
