---
title: 在 Student-AI 中使用 Vercel AI Gateway
description: 了解如何在 Student-AI 中集成和使用 Vercel AI Gateway 的统一 API
tags:
  - Student-AI
  - Vercel AI Gateway
  - API 密钥
...
<Steps>
  ...
  ### 第二步：在 Student-AI 中配置 Vercel AI Gateway

  - 进入 Student-AI 的 `设置` 页面
...
至此，您可以在 Student-AI 中使用 Vercel AI Gateway 提供的模型开始聊天了。
