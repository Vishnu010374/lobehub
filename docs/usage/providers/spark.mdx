---
title: Using iFLYTEK Spark in Student-AI
description: >-
  Learn how to configure and use the iFLYTEK Spark API Key in Student-AI to start
...
# Using iFLYTEK Spark in Student-AI
...
This guide will walk you through how to use iFLYTEK Spark in Student-AI.
...
<Steps>
  ...
  ### Step 2: Configure iFLYTEK Spark in Student-AI
...
That's it! You're now ready to use iFLYTEK Spark's models for conversations in Student-AI.
