---
title: 在 Student-AI 中使用 LM Studio
description: 学习如何配置和使用 LM Studio，并在 Student-AI 中 通过 LM Studio 运行 AI 模型进行对话。
tags:
  - Student-AI
  - LM Studio
  - 开源模型
...
# 在 Student-AI 中使用 LM Studio

<Image alt={'在 Student-AI 中使用 LM Studio'} cover src={'/blog/assets28749075f0c4d62c1642694a4ed9ec08.webp'} />
...
本文档将指导你如何在 Student-AI 中使用 LM Studio:
...
<Steps>
  ...
  ### 步骤五：在 Student-AI 中使用 LM Studio
...
至此你已经可以在 Student-AI 中使用 LM Studio 运行的模型进行对话了。
