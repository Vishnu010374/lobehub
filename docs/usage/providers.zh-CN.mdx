---
title: 在 Student-AI 中使用多模型服务商
description: 了解 Student-AI 在多模型服务商支持方面的最新进展，包括已支持的模型服务商和计划中的扩展，以及本地模型支持的使用方式。
tags:
  - Student-AI
  - AI 会话服务
  - 模型服务商
