...
<AccordionGroup>
  <Accordion title="Built-in Skills">
    Pre-installed skills that ship with Student-AI:
    ...
    Built-in skills are maintained by the Student-AI team and automatically updated.
  </Accordion>

  <Accordion title="Market Skills">
    Community-created skills available from the Student-AI marketplace:
...
Student-AI includes several powerful built-in tools:
...
Extend agent capabilities with plugins from the Student-AI marketplace:
...
MCP is Student-AI's system for connecting agents to external tools and services — databases, APIs, file systems, development tools, and business applications.
