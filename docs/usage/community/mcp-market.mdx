...
The Student-AI MCP Marketplace brings together high-quality MCPs from creators worldwide, with 10,000+ tools ready to extend your Agents.
...
<Steps>
  ...
  ### MCP Client (Student-AI)

  Student-AI acts as an MCP client:
  ...
  - Student-AI sends request to MCP server
...
<Callout type={'info'}>Please exercise caution when using MCPs from unknown sources. Student-AI cannot guarantee the safety of all MCPs.</Callout>

### One-Click Installation (Desktop App)

The Student-AI Desktop application provides the easiest way to install MCP plugins:
...
<Steps>
  ...
  Student-AI automatically checks system dependencies and identifies configuration requirements.

  ### Install Dependencies (if needed)

  If system dependencies are missing, Student-AI provides installation commands for your OS.
  ...
  Student-AI verifies the server is reachable, authentication works, and tools are available.
...
You can add any MCP-compatible server directly to Student-AI without going through the marketplace. See the [Custom MCP](/docs/usage/community/custom-mcp) guide for a step-by-step walkthrough, or the [Skill Management](/docs/usage/community/skill-management) guide for an overview of all skill types.
