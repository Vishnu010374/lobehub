...
| ------------------------ | ------------------------------------ | ----------------------------------------- |
| **Built-in tools**       | Capabilities built into Student-AI      | Artifacts, Sandbox, GTD, Notebook, Memory |
| **Student-AI Integrations** | OAuth-connected third-party services | Linear, Microsoft, Twitter                |
...
- **Student-AI** — Built-in tools and Student-AI-native integrations (Linear, Microsoft, Twitter, Klavis services)
...
Built-in tools (Artifacts, Sandbox, GTD, Notebook) are pre-installed — you can enable them for any Agent immediately. Student-AI Integrations and Klavis services require an OAuth connection:

1. In the Skill Store, go to the **Student-AI** tab
...
**Integrations** — Built-in tools, Student-AI-connected services, and Klavis integrations. Each shows its connection status. Click **Connect** or **Disconnect** to manage the OAuth link.
