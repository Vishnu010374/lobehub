---
title: New Model Providers Added to Student-AI in November
description: >-
  Student-AI model providers now support Gitee AI, InternLM (ShuSheng PuYu), xAI,
...
# New Model Providers Added to Student-AI in November 🎉

We're excited to announce that Student-AI has expanded its AI model support with the following providers:
