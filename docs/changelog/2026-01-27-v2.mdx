---
title: 'Student-AI v2.0 — Group Chat & Multi-Agent Collaboration 🎉'
description: Student-AI v2.0 brings major upgrades including multi-agent group chat, enhanced model settings, SSO-only mode, and desktop improvements.
tags:
  - v2.0
  - Group Chat
  - Multi-Agent
...
January marks the landmark release of Student-AI v2.0, introducing powerful multi-agent group chat capabilities, refined model settings, and a streamlined authentication experience.
...
- Agent Builder: Describe what you want, and Student-AI builds the complete agent—skills, behavior, tools, and personality. No setup required.
