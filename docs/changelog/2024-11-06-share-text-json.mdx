---
title: Student-AI Supports Sharing Conversations in Text Format (Markdown/JSON)
description: >-
  Student-AI v1.28.0 introduces support for exporting conversations in Markdown and
