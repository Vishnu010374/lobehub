...
description: >-
  Student-AI v1.49.12 fully supports the DeepSeek R1 model, bringing an
...
In March, Student-AI continued to refine the user experience—adding practical features like customizable hotkeys and data export, while further expanding the AI provider ecosystem.
