...
description: >-
  Explore the architecture of Student-AI, an open-source AI Agent platform built on
...
Student-AI is an open-source AI Agent platform built on Next.js, enabling users to interact with AI through natural language, use tools, manage knowledge bases, and more. The following is an overview of Student-AI's architecture design.

## Application Architecture Overview

The overall architecture of Student-AI consists of the following core layers:
...
Student-AI uses [Better Auth](https://www.better-auth.com/) as the authentication framework, supporting:
