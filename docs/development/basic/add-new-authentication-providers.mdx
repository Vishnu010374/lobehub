...
description: Learn how to implement a new authentication provider using Auth.js in Student-AI.
tags:
  - Authentication
  - Auth.js
  - Student-AI
...
Student-AI uses [Auth.js v5](https://authjs.dev/) as the external authentication service. Auth.js is an open-source authentication library that provides a simple way to implement authentication and authorization features. This document will introduce how to use Auth.js to implement a new authentication provider.

## Architecture Overview

To add a new authentication provider in Student-AI (for example, adding Okta), you need to follow the steps below:
...
Now, you can use Okta as your provider to implement the authentication feature in Student-AI.
