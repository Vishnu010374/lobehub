...
description: >-
  Explore the client-server interaction logic of Student-AI Chat API, including
...
Student-AI Chat API in client-server interactions,
...
Student-AI supports three types of tools:
...
abstraction layer in Student-AI for interacting with
...
Agent Runtime (`packages/agent-runtime/`) is Student-AI's
