---
title: 构建属于自己的 Student-AI - 自选部署平台
description: >-
  选择适合自己的部署平台，构建个性化的 Student-AI。支持 Docker、Docker
...
Student-AI 支持私有化部署，让你完全掌控自己的数据、自定义选项和部署环境。无论是为团队、组织还是个人使用，Student-AI 都提供多种部署方式。

<PlatformCards urlPrefix={'platform'} />

## 架构概述

Student-AI 由以下几个关键组件组成：
...
5. **定期更新** — 保持 Student-AI 及依赖项的版本最新
