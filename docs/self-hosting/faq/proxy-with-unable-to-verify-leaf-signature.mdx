---
title: Resolving `UNABLE_TO_VERIFY_LEAF_SIGNATURE` Error in Student-AI When Using Proxy
description: >-
  Learn how to bypass Node.js certificate validation to resolve certificate
  verification errors in Student-AI when using a proxy with self-signed or
