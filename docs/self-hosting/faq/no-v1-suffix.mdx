---
title: Troubleshooting `OPENAI_PROXY_URL` in Student-AI Configuration for Empty Response
description: >-
  Learn how to troubleshoot and resolve the issue of receiving an empty response
  after configuring the Student-AI `OPENAI_PROXY_URL` environment variable.
tags:
  - OPENAI_PROXY_URL
