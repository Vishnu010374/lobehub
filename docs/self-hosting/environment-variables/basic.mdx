---
title: Customize Student-AI Deployment with Environment Variables
description: >-
  Learn about the common environment variables used to customize Student-AI
...
Student-AI provides some additional configuration options during deployment, which can be customized using environment variables.
...
- Type: Optional
- Description: Add a password to access the Student-AI service. You can set a long password to prevent brute force attacks.
- Default: -
...
- Type: Optional
- Description: Used to configure models and providers for Student-AI system agents (such as topic generation, translation, etc.).
- Default value: `-`
...
- Type: Optional
- Description: Used to control Student-AI's feature functionalities. Supports multiple feature flags, using `+` to add a feature and `-` to disable a feature. Separate multiple feature flags with a comma `,` and enclose the entire value in quotes `"` to avoid parsing errors.
- Default: `-`
...
Student-AI performs SSRF security checks in the following scenarios:

1. **Image/Video URL to Base64 Conversion**: When processing media messages (e.g., vision models, multimodal models), Student-AI converts image and video URLs to base64 format. This check prevents malicious users from accessing internal network resources.
...
- Type: Optional
- Description: Index address of the Student-AI plugin market. If you have deployed the plugin market service on your own, you can use this variable to override the default plugin market address.
...
- Type: Optional
- Description: Index address of the Student-AI assistant market. If you have deployed the assistant market service on your own, you can use this variable to override the default market address.
