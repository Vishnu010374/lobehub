---
title: Student-AI Model Service Providers - Environment Variables and Configuration
description: >-
...
When deploying Student-AI, a rich set of environment variables related to model service providers is provided, allowing you to easily define the model service providers to be enabled in Student-AI.
