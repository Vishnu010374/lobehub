---
title: Student-AI 身份验证服务设置
description: 了解如何配置 Student-AI 的身份验证服务环境变量，包括 Better Auth、OAuth SSO 等。
tags:
  - Student-AI
  - 身份验证服务
  - Better Auth
...
Student-AI 在部署时提供了完善的身份验证服务能力，以下是相关的环境变量，你可以使用这些环境变量轻松定义需要在 Student-AI 中开启的身份验证服务。
