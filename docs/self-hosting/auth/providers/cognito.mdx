---
title: Configuring AWS Cognito Authentication for Student-AI
description: >-
  Learn how to configure AWS Cognito SSO for Student-AI, including creating a User
