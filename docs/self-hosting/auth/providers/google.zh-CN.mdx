---
title: 在 Student-AI 中配置 Google 身份验证
description: 学习如何在 Student-AI 中配置 Google SSO，包括在 Google Cloud Console 创建 OAuth 凭证和设置环境变量。
tags:
  - Google
  - 身份验证
  - Student-AI
...
<Callout type={'info'}>
  部署成功后，用户将可以通过 Google 身份认证并使用 Student-AI。
</Callout>
