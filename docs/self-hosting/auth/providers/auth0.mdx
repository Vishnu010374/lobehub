---
title: Configuring Auth0 Authentication for Student-AI
description: >-
  Learn how to configure Auth0 SSO for Student-AI, including creating applications,
...
<Callout type={'warning'}>
  When creating a GitHub connection, make sure to enable the **Email Address** permission in the **Attributes** section. Student-AI requires user email for authentication.
