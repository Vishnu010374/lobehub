---
title: Configuring Okta Authentication for Student-AI
description: >-
  Learn how to configure Okta SSO for Student-AI, including creating an application
...
<Steps>
  ...
  5. Configure the application:
     - App integration name: `Student-AI`
  ...
  | `AUTH_SSO_PROVIDERS` | Required | SSO provider for Student-AI. Use `okta` for Okta                                 |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Okta and use Student-AI.
</Callout>
