---
title: Configuring Generic OIDC Authentication for Student-AI
description: >-
  Learn how to configure any OpenID Connect provider for Student-AI using Generic
  OIDC integration.
tags:
  - Generic OIDC
  - OpenID Connect
...
Use Generic OIDC to integrate Student-AI with any OpenID Connect compliant identity provider not explicitly listed in our supported providers.
