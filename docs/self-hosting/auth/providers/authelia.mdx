---
title: Configuring Authelia Authentication for Student-AI
description: >-
  Learn how to configure Authelia SSO for Student-AI, including setting up OIDC
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`   | Required | SSO provider for Student-AI. Use `authelia` for Authelia                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authelia and use Student-AI.
</Callout>
