---
title: Configuring Authentik Authentication for Student-AI
description: >-
  Learn how to configure Authentik SSO for Student-AI, including creating an OAuth2
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`    | Required | SSO provider for Student-AI. Use `authentik` for Authentik                       |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authentik and use Student-AI.
</Callout>
