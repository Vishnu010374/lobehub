---
title: 在 Student-AI 中配置 Okta 身份验证
description: 学习如何在 Student-AI 中配置 Okta SSO，包括创建应用和设置环境变量。
tags:
  - Okta
  - 身份验证
  - Student-AI
...
<Callout type={'info'}>部署成功后，用户将可以通过 Okta 身份认证并使用 Student-AI。</Callout>
