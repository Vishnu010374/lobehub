---
title: Configuring Logto Authentication for Student-AI
description: >-
  Learn how to configure Logto SSO for Student-AI, including creating an
...
<Steps>
  ...
  4. Fill in the application name: `Student-AI`
  ...
  | `AUTH_SSO_PROVIDERS`        | Required | SSO provider for Student-AI. Use `logto` for Logto                               |
  ...
  Configure Logto [Webhook](https://docs.logto.io/developers/webhooks/configure-webhooks) to sync user data updates to Student-AI.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Logto and use Student-AI.
</Callout>
