---
title: 在 Student-AI 中配置 Authentik 身份验证
description: 学习如何在 Student-AI 中配置 Authentik SSO，包括创建 OAuth2 提供商和应用。
tags:
  - Authentik
  - 身份验证
  - Student-AI
...
<Callout type={'info'}>部署成功后，用户将可以通过 Authentik 身份认证并使用 Student-AI。</Callout>
