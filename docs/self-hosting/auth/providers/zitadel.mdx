---
title: Configuring ZITADEL Authentication for Student-AI
description: >-
  Learn how to configure ZITADEL SSO for Student-AI, including creating an
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`  | Required | SSO provider for Student-AI. Use `zitadel` for ZITADEL                           |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with ZITADEL and use Student-AI.
</Callout>
