---
title: Configuring Cloudflare Zero Trust Authentication for Student-AI
description: >-
  Learn how to configure Cloudflare Zero Trust SSO for Student-AI, including
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`                | Required | SSO provider for Student-AI. Use `cloudflare-zero-trust`                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Cloudflare Zero Trust and use Student-AI.
</Callout>
