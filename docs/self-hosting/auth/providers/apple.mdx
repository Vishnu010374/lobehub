---
title: Configuring Apple Authentication for Student-AI
description: >-
  Learn how to configure Apple Sign In for Student-AI, including creating
...
<Steps>
  ...
  3. Fill in:
     - **Description**: e.g., `Student-AI Web`
