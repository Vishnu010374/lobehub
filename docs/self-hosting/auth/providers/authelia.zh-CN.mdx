---
title: 在 Student-AI 中配置 Authelia 身份验证
description: 学习如何在 Student-AI 中配置 Authelia SSO，包括设置 OIDC 客户端和环境变量。
tags:
  - Authelia
  - 身份验证
  - Student-AI
...
<Callout type={'info'}>部署成功后，用户将可以通过 Authelia 身份认证并使用 Student-AI。</Callout>
