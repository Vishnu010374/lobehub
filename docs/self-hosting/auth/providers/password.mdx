---
title: Configuring Email/Password Authentication for Student-AI
description: >-
  Learn how to configure email and password authentication for Student-AI,
...
Student-AI supports traditional email and password authentication out of the box.
