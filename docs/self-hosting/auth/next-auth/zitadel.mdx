---
title: Configure ZITADEL Authentication Service for Student-AI
description: >-
  Learn how to configure ZITADEL Authentication Service for Student-AI deployment,
  including creating ZITADEL applications, setting up environment variables, and
  enabling single sign-on (SSO).
tags:
  - ZITADEL Authentication
  - Student-AI Deployment
  - Single Sign-On (SSO)
...
<Steps>
  ...
  <Callout type={'important'}>
    ...
    - Replace `http(s)://your-domain` with the actual URL that Student-AI is deployed to.
  </Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use Student-AI using existing
