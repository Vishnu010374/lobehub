---
title: Configuring Github Authentication Service for Student-AI
description: >-
  Learn how to configure Github authentication service for Student-AI, including
...
<Steps>
  ...
  | `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for Student-AI. Use `github` for Github.                                                                                                                              |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use Student-AI.
</Callout>
