---
title: Configure Okta Identity Verification Service for Student-AI
description: >-
  Learn how to configure Okta Identity Verification Service for Student-AI for your
...
<Steps>
  ...
  | ---------------------- | ------------------------------------------------------------------------------------------------------------ | --------------------------------------------- |
  | App Integration Name   | The Application Name your users will see                                                                     | Student-AI Instance                              |
  ...
  Click on the "Assignments" in the top navigation bar to enter the user management interface, where you can create or assign users in your organization to log in to Student-AI.
...
<Callout>
  After successful deployment, users will be able to authenticate and use Student-AI using the users
  configured in Okta.
</Callout>
