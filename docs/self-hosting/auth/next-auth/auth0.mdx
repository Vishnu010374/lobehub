---
title: Configure Auth0 Identity Verification Service for Student-AI
description: >-
  Learn how to configure Auth0 Identity Verification Service for Student-AI for
...
<Steps>
  ...
  Click on the "Users Management" in the left navigation bar to enter the user management interface, where you can create users for your organization to log in to Student-AI.
...
<Callout type={'warning'}>
  ...
  Student-AI being abused by external users.
</Callout>
