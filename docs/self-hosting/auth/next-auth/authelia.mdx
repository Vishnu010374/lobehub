---
title: Configuring Authelia Authentication Service for Student-AI
description: >-
  Learn how to configure Authelia authentication service in Student-AI, including
  creating a provider, configuring environment variables, and deploying Student-AI.
...
<Steps>
  ...
  Make sure to replace secret and `redirect_urls` with your own values. Note! The secret configured in Authelia is ciphertext, i.e., a salted hash value. Its corresponding plaintext needs to be filled in Student-AI later.
