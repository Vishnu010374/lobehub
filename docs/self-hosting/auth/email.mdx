...
description: >-
  Configure Student-AI email service for email verification, password reset, and
  magic link login.
tags:
  - Email Service
  - SMTP
...
Email service is used for email verification, password reset, and magic link delivery. Student-AI supports two email service providers.
