---
title: Deploying Student-AI Database with Docker
description: >-
  Learn how to deploy the Student-AI server database version using Docker on Linux
  and local machines.
tags:
  - Student-AI
  - Docker
...
Here is the process for deploying the Student-AI server database version on a Linux server:
...
<Steps>
  ...
  <Callout type="info">
    ...
    components for Student-AI to implement RAG and knowledge base search.
  </Callout>
...
The data version of Student-AI also supports direct use on a local Mac/Windows machine.
