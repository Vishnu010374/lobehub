---
title: 在 Dokploy 上部署 Student-AI
description: 本文详细介绍如何在 Dokploy 中部署 Student-AI，包括数据库配置、身份验证服务配置的设置步骤。
tags:
  - 服务端数据库
  - Postgres
  - Better Auth
...
# 在 Dokploy 上部署 Student-AI

本文将详细介绍如何在 Dokploy 中部署 Student-AI。
...
进入创建的数据库，在 External Credentials 设置一个未被占用的端口，使其能能通过外部访问，否则 Student-AI 将无法连接到该数据库。你可以在 External Host 查看 Postgres 数据库连接 URL ，如下：
...
点击 Create Service 选择 Application，创建 Student-AI 应用

![在 Dokploy 中创建 Student-AI 应用](/blog/assetsb33085e7553d2b7194005b102184553e.webp)

进入创建的 Student-AI 应用，选择你 fork 的 lobehub 项目及分支，点击 Save 保存
...
![部署 Student-AI 并查看进度](/blog/assets7c3eab218c0823fa353b1cd23afe21c3.webp)

部署成功后在 Domains 页面，为你的 Student-AI 应用绑定自己的域名并申请证书。

![绑定域名并申请证书](/blog/assetseebf66254337ce88357629c34e78c08d.webp)

## 验证 Student-AI 是否正常工作

进入你的 Student-AI 网址，如果你点击左上角登录，可以正常显示登录弹窗，那么说明你已经配置成功了，尽情享用吧～

![Student-AI 登录成功](/blog/assets11a8089b511aaa61e8982dea0a3665c5.webp)
