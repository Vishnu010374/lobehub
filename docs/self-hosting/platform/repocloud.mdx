---
title: Deploy Student-AI with Database on RepoCloud
description: >-
  Learn how to deploy Student-AI on RepoCloud with ease, including database,
...
# Deploying Student-AI Database Edition with RepoCloud

If you want to deploy Student-AI Database Edition on RepoCloud, you can follow the steps below:
