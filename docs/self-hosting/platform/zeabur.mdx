---
title: Deploying Student-AI Database on Zeabur
description: >-
  Learn how to deploy Student-AI on Zeabur with ease. Follow the provided steps to
...
# Deploying Student-AI Database on Zeabur
...
Here is the process for deploying the Student-AI server database version on Zeabur:

<Steps>
  ### Go to the template page on Zeabur

  Go to the [Student-AI Database template page](https://zeabur.com/templates/RRSPSD) on Zeabur and click on the "Deploy" button.
  ...
  - Student-AI Domain: A free subdomain with `.zeabur.app` suffix.
  ...
  After you fill all the required environment variables, select a region where you want to deploy your Student-AI Database and click on the "Deploy" button.
  ...
  Fill in those variables into your Student-AI service on Zeabur, here is a more detailed guide for [editing environment variables on Zeabur](https://zeabur.com/docs/deploy/variables).

  For detailed configuration of Logto, refer to [this document](/docs/self-hosting/auth/providers/logto).

  ### Access your Student-AI Instance

  Press on the `Student-AI-Database` and you can see the public domain you just created, click on it to access your Student-AI Database.
