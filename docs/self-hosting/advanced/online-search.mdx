...
title: >-
  ...
  Information
description: >-
  Learn how to configure the SearXNG online search functionality for Student-AI,
...
You can find publicly available SearXNG instances in the [SearXNG instance list](https://searx.space/). Choose an instance that is fast and reliable, and then configure its URL in Student-AI.
...
1. Restart the Student-AI service.
...
- [Student-AI Online Search RFC Discussion](https://github.com/lobehub/lobehub/discussions/6447)
