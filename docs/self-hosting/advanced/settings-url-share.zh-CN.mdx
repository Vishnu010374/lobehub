---
title: URL 分享设置参数 - Student-AI 配置快速设置
description: 了解如何从外部 URL 导入和导出 Student-AI 的设置参数，包括 keyVaults 和 languageModel，以及参数格式和类型。
tags:
  - URL 分享
  - 设置参数
  - Student-AI
...
Student-AI 支持从外部 URL 导入设置参数，以便于快速设置 Student-AI 的配置。
...
<Callout type={'warning'}>
  Student-AI 不对 URL 中的设置参数进行正确性校验，也不提供 URL 的加密、解密方法，请谨慎使用。
</Callout>
