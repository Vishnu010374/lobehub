---
title: Student-AI Knowledge Base / File Upload
description: >-
  Explore Student-AI's file upload and knowledge base management features with core
  components.
tags:
  - Student-AI
  - File Upload
...
Student-AI supports file upload and knowledge base management. This feature relies on the following core technical components. Understanding these components will help you successfully deploy and maintain the knowledge base system.
...
<Callout type={'info'}>
  Student-AI currently uses OpenAI's `text-embedding-3-small` model by default. Ensure your API Key
...
By correctly configuring and integrating these core components, you can build a powerful and efficient knowledge base system for Student-AI. Each component plays a crucial role in the overall architecture, supporting advanced document management and intelligent retrieval functions.
