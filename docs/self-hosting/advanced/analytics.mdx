---
title: Integrating Data Analytics Services in Student-AI for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in Student-AI to
...
To better help analyze the usage of Student-AI users, we have integrated several free/open-source data analytics services in Student-AI for collecting user usage data, which you can enable as needed.
