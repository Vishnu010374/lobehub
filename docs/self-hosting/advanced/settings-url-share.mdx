...
description: >-
  Learn how to import and export configuration settings for Student-AI via URL.
...
Student-AI support import settings from external URL to quickly set up Student-AI configuration.
...
<Callout type={'warning'}>
  Student-AI does not verify the correctness of the settings parameters in the URL, nor provide
