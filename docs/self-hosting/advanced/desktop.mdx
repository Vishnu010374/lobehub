---
title: Automatic Synchronization with Student-AI Desktop
description: Configure Student-AI Desktop for a synchronized experience
tags:
  - Student-AI
...
# Automatic Synchronization with Student-AI Desktop

Student-AI Desktop provides users with an enhanced experience while also expanding the capabilities of Student-AI, allowing users to utilize Student-AI in offline environments. This document will guide you on how to configure Student-AI Desktop and connect it to your self-hosted instance.

## System Requirements

Student-AI Desktop is built using Electron and supports the following operating systems:
...
The version release of Student-AI Desktop follows this logic:

- **Beta Version**: All merges to the main branch that are automatically released will be created as Beta versions of Student-AI Desktop.
...
Student-AI Desktop can connect to your self-hosted Student-AI instance, allowing you to use your self-hosted configuration on the desktop.
...
If you are deploying Student-AI using one-click deployment methods (such as Vercel, Railway, etc.), you need to:
...
1. Open Student-AI Desktop.
2. Click the Wi-Fi icon in the upper right corner.
3. Enter the address of your self-hosted instance (e.g., `https://your-Student-AI-instance.com`).
...
- Example file names:
  - Apple Silicon: `Student-AI-Beta-1.83.6-arm64.dmg` or `Student-AI-Beta-1.83.6-arm64-mac.zip`
  - Intel: `Student-AI-Beta-1.83.6-x64.dmg` or `Student-AI-Beta-1.83.6-mac.zip`
