---
title: Build Your Own Student-AI - Choose Your Deployment Platform
description: >-
  Explore multiple deployment platforms like Vercel, Docker, Docker Compose, and
  more to deploy Student-AI. Choose the platform that best suits your needs.
tags:
  - Student-AI
  - Deployment Platform
  - Vercel
...
# Build Your Own Student-AI

Student-AI can be self-hosted on your own infrastructure, giving you complete control over your data, customization, and deployment environment. Whether you're deploying for a team, organization, or personal use, Student-AI supports multiple deployment methods.

<PlatformCards urlPrefix={'platform'} />

## Architecture Overview

Student-AI consists of several key components:
...
Before deploying Student-AI, gather the following:
...
5. **Regular updates** — Keep Student-AI and dependencies up to date
