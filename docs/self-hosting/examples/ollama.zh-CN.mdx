---
title: 在 Student-AI 中集成 Ollama
description: 学习如何在 Student-AI 中配置与部署 Ollama 语言模型框架，提升本地大模型使用体验。
tags:
  - Ollama
  - Student-AI
  - 语言模型
...
本文档将指导你如何配置与部署 Student-AI 来使用 Ollama：
...
假设你已经在本地 `11434` 端口启动了 Ollama 服务。运行以下 Docker 命令行，在本地启动 Student-AI：
...
关于在 Student-AI 中使用 Ollama 的更多信息，请查阅 [Ollama 使用](/zh/docs/usage/providers/ollama)。
