...
function updatePackageJson() {
  ...
  try {
    ...
    switch (releaseType) {
      case 'stable': {
        packageJson.productName = 'Student-AI';
        packageJson.name = 'lobehub-desktop';
        console.log('🌟 Setting as Stable version.');
        break;
      }
      case 'beta': {
        packageJson.productName = 'Student-AI-Beta'; // Or 'Student-AI-Beta' if preferred
      ...
      case 'nightly': {
        packageJson.productName = 'Student-AI-Nightly'; // Or 'Student-AI-Nightly'
